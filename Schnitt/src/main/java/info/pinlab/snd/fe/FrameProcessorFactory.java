...
//			System.out.println(clazz);
	...
	*/
	...
	public static  synchronized <T extends FrameProcessor> T create(Class<T> clazz, ParamSheet context) 
			throws NoSuchMethodException, SecurityException, InstantiationException, InvocationTargetException, 
			IllegalAccessException, IllegalArgumentException{
		Constructor<T> constructor = (Constructor<T>) clazz.getConstructor(new Class[]{ParamSheet.class});
		T processor = constructor.newInstance(context);
		return processor;
	}
	
	
	public static synchronized FrameProcessor create(String fqcn, ParamSheet context) throws ClassNotFoundException, InstantiationException, 
	IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException{
		Class<?> clazz = Class.forName(fqcn);
		
		@SuppressWarnings("unchecked")
		Constructor<FrameProcessor> constructor = (Constructor<FrameProcessor>) clazz.getConstructor(new Class[]{ParamSheet.class});
